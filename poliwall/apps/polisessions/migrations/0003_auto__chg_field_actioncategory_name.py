...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ActionCategory.name'
        db.alter_column(u'polisessions_actioncategory', 'name', self.gf('django.db.models.fields.CharField')(max_length=400))

    def backwards(self, orm):

        # Changing field 'ActionCategory.name'
        db.alter_column(u'polisessions_actioncategory', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))
