...
class Session(models.Model):
    ...
    legislative = models.ForeignKey(Legislative, verbose_name=_(u'Legislatura'), related_name='legislatives_sessions')
    house = models.ForeignKey(House, verbose_name=_(u'Cámara'), related_name='houses_sessions')
