...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Legislative.roman_code'
        db.add_column(u'polidata_legislative', 'roman_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Legislative.roman_code'
        db.delete_column(u'polidata_legislative', 'roman_code')
