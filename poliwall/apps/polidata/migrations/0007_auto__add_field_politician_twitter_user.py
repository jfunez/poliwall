...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Politician', fields ['sex']
        db.create_index(u'polidata_politician', ['sex'])


    def backwards(self, orm):
        # Removing index on 'Politician', fields ['sex']
        db.delete_index(u'polidata_politician', ['sex'])
