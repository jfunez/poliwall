...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Politician.profile_id'
        db.add_column(u'polidata_politician', 'profile_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'Politician.biography'
        db.add_column(u'polidata_politician', 'biography',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Politician.profile_id'
        db.delete_column(u'polidata_politician', 'profile_id')

        # Deleting field 'Politician.biography'
        db.delete_column(u'polidata_politician', 'biography')
