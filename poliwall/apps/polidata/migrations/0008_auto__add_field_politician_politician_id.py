...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Politician.politician_id'
        db.add_column(u'polidata_politician', 'politician_id',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Politician.politician_id'
        db.delete_column(u'polidata_politician', 'politician_id')
